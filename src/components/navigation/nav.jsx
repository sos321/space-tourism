    ...
    <Fragment>
      <div className="flex items-center justify-between w-full h-16 mt-16 lg:mt-3">
        ...
        {isMobile ? (
          ...
          <LayoutGroup>
            <div
              className="flex items-center justify-center w-7/12 h-24 lg:w-8/12 sm:gap-8 lg:gap-14 gap-[4.5rem] bg-white backdrop-blur-2xl bg-opacity-5"
      ...
      <div className="h-[calc(100%-14rem)] lg:h-[calc(100%-10.75rem)]  max-w-[80%] mt-24 sm:mt-10 mx-auto">
        <Outlet />
      </div>
    </Fragment>
  );
